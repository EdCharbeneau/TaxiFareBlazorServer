...
namespace TaxiFarePrediction
{
    internal class Program
    {
        ...
        private static readonly string ModelPath = Path.Combine(RootPath, "MLModels", "TaxiFareModel.zip");
        ...
        private static void Evaluate(MLContext mlContext, ITransformer trainedModel, IDataView testDataView)
        {
            ...
            ConsoleHelper.PrintRegressionMetrics("Sdca Regression Trainer", metrics);
        }
        private static void BuildTrainEvaluateAndSaveModel(MLContext mlContext)
        {
            ...
            SaveModelToDisk(mlContext, trainedModel);

        }

        private static void SaveModelToDisk(MLContext mlContext, ITransformer trainedModel)
        {
        ...
        private static void TestSinglePrediction()
        {
            ...
            var taxiTripSample = SingleTaxiTripSample.TestTrip;

            var service = new TaxiFarePredictionService(ModelPath);
